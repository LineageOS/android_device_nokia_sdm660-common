...
# QTI
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/telephony_system_ext_privapp-permissions-qti.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/telephony_system_ext_privapp-permissions-qti.xml \
